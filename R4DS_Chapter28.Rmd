...
[Not sure what this is intended to show. I assume it's that after removing effects of all the coloured linear models, we're left with this one that's fairly 'flat'? Otherwise, I assume it's that the coloured models shouldn't be straight lines?]
