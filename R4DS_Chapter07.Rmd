...
...and it mostly just shows that `cut=Fair` is a step below the other `cut`s
...
A5.
Most data points are along a tight line (which is clear). We are interested in the outliers, and whether they reveal more insight/ pattern/ error. By aggregating/binning the (few) outliers, we'd lose detail of how much they disagree with the main data, and whether they have clusters
