...
A1.
(I think) this refers to `lm(lifeExp ~ year, data = df)` from s25.2.2 leaving some large residuals (especially for some African countries during 1980-2000 ish)

See : [https://jrnold.github.io/r4ds-exercise-solutions/many-models.html#gapminder]
...I don't have the **gapminder** package
