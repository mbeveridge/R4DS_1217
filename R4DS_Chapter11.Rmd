...
"Only two columns are specified in the header `a` and `b`, but the rows have three columns, so the last column is dropped" -- https://jrnold.github.io/r4ds-exercise-solutions/data-import.html#exercises-14
