...
# This answer from [https://jrnold.github.io/r4ds-exercise-solutions/strings.html#grouped-matches] includes matches which aren't really numbers eg. "(of)ten served", "(fas)ten your shoe", "(d)one before". (No sentences include `zero` or `none`, so their omission from `numword` has no effect)
```
...
# This answer from [https://jrnold.github.io/r4ds-exercise-solutions/strings.html#grouped-matches]. (Not sure how unpaired `[` works, but gives errors without.) This answer finds the contractions (1st part), but doesn't do the 2nd part
```
