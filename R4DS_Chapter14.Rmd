...
https://jrnold.github.io/r4ds-exercise-solutions/strings.html#extract-matches : "Add the `\b` before and after the pattern", which is similar but different to `\s`. ("You can also match the boundary between words with `\b`" -- s14.3.2). Copied from there (but edited `more2`) :
...
A2.3
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
Answers to Q2 at https://jrnold.github.io/r4ds-exercise-solutions/strings.html#extract-matches use things we haven't covered in the R4DS book yet ...`[a-zA-Z]`, `unique()`, `unlist()`
