...
`*` : 0 or more -- s14.3.4 : "There is no direct equivalent of `*` in `{m,n}` form since there are no bounds on the matches: it can be 0 up to infinity matches" -- https://jrnold.github.io/e4qf/strings.html
