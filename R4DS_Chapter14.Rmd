...
# Alternative. Same results in Console (not Viewer)
...
# Replaced `words` with "baeiout", and code worked (matched) -- Suggested by https://jrnold.github.io/r4ds-exercise-solutions/strings.html#exercises-1
```
...
# max is 100%, when the word is a vowel
