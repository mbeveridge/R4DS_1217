...
Other possible improvements to consider : descending values (ie. reading down an ordered list of `count`), consistent bin size (but we can't affect that) ...and maybe grouping some 'no answer' categories, if no values can be got from them
