...
flights %>%
  ...
  count(tailnum, sort = TRUE)                   # 2512 rows (only) where it's because the `tailnum` is `NA`
...
A3.
```{r}
# As mentioned in 13.3.1 Exercises A2, "Package wasn't in the Anaconda distribution", so I haven't installed it
