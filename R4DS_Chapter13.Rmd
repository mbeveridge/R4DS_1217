...
flights %>%
  ...
  ggplot(aes(x = age, y = delay)) +
  geom_point() +                                           # 'By eye', the points suggest a slightly -ve correlation
  geom_abline()                                            # Line says +ve correlation, but biased towards 'young'?
...
flights %>%
  ...
  ggplot(aes(x = age, y = delay)) +
  geom_point() +
  geom_abline()                                            # Similar. A correlation using `mean` is invalid anyway?
```
