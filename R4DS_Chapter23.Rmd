...
# add the predictions and residuals from a `loess` regression to the `sim1` data
sim1 <- sim1 %>%
  add_residuals(sim1_loess, var = "resid_loess") %>%    # `add_residuals`
  add_predictions(sim1_loess, var = "pred_loess")       # `add_predictions`
```
