...
* The model equation gains an extra `-1` term. The predictions are the same

Better comparison, from [https://jrnold.github.io/r4ds-exercise-solutions/model-basics.html#formulas-and-model-families] :
```{r}
